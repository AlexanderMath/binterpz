...
class AtomDiffusion(Module):
    ...
    def sample(
        ...
        **network_condition_kwargs,
        ...
        import dill 
        import sys 
        print('Saving `diffusion_conditioning.pkl`... ', end='')
        dill.dump([self, atom_mask, num_sampling_steps, multiplicity, max_parallel_samples, steering_args, network_condition_kwargs], 
                  open(f"diffusion_conditioning_{sys.argv[2]}.pkl", "wb"))
        #print("DONE!")
        #exit()
